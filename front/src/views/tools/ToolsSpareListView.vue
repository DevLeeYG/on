<template>
  ...
  <div class="container">
    ...
    <div class="text-end">
      <DetailSpecButton class="me-4" />
      <router-link to="/tools/sparelist/add/tools">
        <button class="btn btn-primary me-4">공구 등록</button>
      </router-link>
    </div>
              ...
              <div class="col-auto">
                <div class="form-check">
                  <input
                    ...
                    id="isUnsafe"
                    v-model="isUnsafe"
                    @change="onChangeUnsafe"
                  />
                  <label class="form-check-label" for="isUnsafe">안전재고 이하</label>
                </div>
              </div>
              <div class="col-4">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header bg-danger">
              <h1 class="modal-title fs-5" id="stockModalLabel">재고 수정</h1>
              <button
                type="button"
                class="btn-close"
            ...
            <div class="modal-body border m-3">
              ...
              <div class="d-flex">
                ...
                <!-- <div class="form-group m-2 mb-3">
                  <label for="safetyStockCount" class="form-label">비고</label>
                  <input type="text" class="form-control" id="safetyStockCount" />
                </div> -->
              </div>
            </div>
